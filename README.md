...
- **Who the bot answers.** While `WHATSAPP_ALLOWED_NUMBERS` is set, the bot replies only to
  ...
  (default `jan 2027, january 2027, your last attempt, join now`, matched as whole words anywhere in the
...
- **The January 2027 campaign script.** A lead arriving from any of the ads ("Jan 2027", "Your Last Attempt" or "Join Now") is asked one qualifying
